...
where $r_{t-1}$ is the previous day's log return, $\sigma^{(5)}_{t-1}$ is the 5-day lagged rolling volatility, and $\sigma^{(21)}_{t-1}$ is the 21-day lagged rolling volatility.
