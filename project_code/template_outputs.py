...
def build_baseline_metric() -> dict:
    return {
        ...
        "notes": "Linear regression on 3 lagged features. Test set: 2024-05-09 to 2026-05-12.",
        "is_template": False,
    }
...
def build_milestone_manifest() -> dict:
    return {
        ...
        "sources": [
            {
                "name": "yfinance:USDINR=X",
                "status": "ok",
                "probe_artifact": "data/raw/usdinr.csv",
            },
            {
                "name": "FRED:VIXCLS",
                "status": "ok",
                "probe_artifact": "data/raw/probe_vix.csv",
            },
            {
                "name": "FRED:DTWEXBGS",
                "status": "ok",
                "probe_artifact": "data/raw/probe_dxy.csv",
            },
            {
                "name": "FRED:DCOILWTICO",
                "status": "ok",
                "probe_artifact": "data/raw/probe_oil.csv",
            },
            {
                "name": "FRED:FEDFUNDS",
                "status": "ok",
                "probe_artifact": "data/raw/probe_ffr.csv",
            },
        ],
        "baseline_ready": True,
